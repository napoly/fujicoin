...
```
./gitian-build.py --setup satoshi f0.19.0
```

By default, base VM of Ubuntu bionic will be created.

Where `satoshi` is your Github name and `f0.19.0` is the most recent tag. 
...
All:
 ...
 `./gitian-build.py --detach-sign --no-commit -b satoshi f0.19.0`

Linux:

 `./gitian-build.py --detach-sign --no-commit -b -o l satoshi f0.19.0`

Windows:

 `./gitian-build.py --detach-sign --no-commit -b -o w satoshi f0.19.0`

OSX:

 `./gitian-build.py --detach-sign --no-commit -b -o m satoshi f0.19.0`
