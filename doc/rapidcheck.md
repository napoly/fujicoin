# RapidCheck property-based testing for Fujicoin Core

## Concept

Property-based testing is experimentally being added to Fujicoin Core with
...
If RapidCheck is installed, Fujicoin Core will automatically run the
...
3. Configure Fujicoin Core with RapidCheck.

    `cd` to the directory of your local fujicoin repository and run
...
4. Build Fujicoin Core with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_fujicoin-crypto_gen.o
    CXX      test/test_fujicoin-key_properties.o
    ```
...
That's it! You are now running property-based tests in Fujicoin Core.
